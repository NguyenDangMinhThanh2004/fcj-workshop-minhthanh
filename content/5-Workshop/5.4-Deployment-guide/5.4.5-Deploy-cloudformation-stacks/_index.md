...
![Upload WAF template](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image7.png)

Choose **Next**.

![CloudFormation WAF stack details](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image8.png)

Set the stack name to `HaShop-WAF`, then continue with **Next**.

![Set WAF stack name](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image9.png)

Review the configuration and choose **Submit**.

![Submit WAF stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image10.png)
...
![Upload foundation template](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image11.png)

Set the stack name exactly to `cf-hashop-foundation`.

![Set foundation stack name](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image12.png)
...
![Foundation stack parameters](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image13.png)
...
![Foundation Lambda and WAF parameters](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image14.png)
...
![Create ECS services stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image15.png)

In the container image parameters, replace `<ACCOUNT_ID>` with the real AWS account ID.

![ECS container image parameters](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image16.png)
...
![Upload database initialization template](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image17.png)

Set a stack name for the database initialization stack.

![Database initialization stack name](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image18.png)

Review the stack configuration.

![Database initialization review](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image19.png)
