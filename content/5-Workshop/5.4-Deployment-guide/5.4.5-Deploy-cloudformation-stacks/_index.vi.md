...
![Thông tin WAF stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image8.png)

Ð?t stack name là `HaShop-WAF`, sau dó ti?p t?c ch?n **Next**.

![Ð?t tên WAF stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image9.png)
...
![Ð?t tên foundation stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image12.png)
...
![Parameter c?a foundation stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image13.png)
...
![Parameter Lambda và WAF](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image14.png)
...
![T?o ECS services stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image15.png)

? ph?n container image, thay `<ACCOUNT_ID>` b?ng AWS account ID th?t.

![Parameter container image c?a ECS](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image16.png)
...
![Ð?t tên database initialization stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image18.png)

Ki?m tra l?i c?u hình stack.

![Review database initialization stack](/fcj-workshop-minhthanh/images/5-Workshop/hashop-deployment/image19.png)
